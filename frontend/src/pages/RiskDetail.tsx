  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4 flex flex-col items-center justify-center">
          <RiskGauge score={detail.composite_score} label="Composite Score" />
        </div>

        <div className="lg:col-span-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4">
          <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-4">Risk Component Breakdown</h3>
          <div className="space-y-4">
            {detail.components.map((c) => (
              <div key={c.name} className="group cursor-pointer" onClick={() => setDrilldownComponent(c.name)}>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex-1 bg-gray-50 dark:bg-gray-800 rounded-full h-3 group-hover:bg-gray-100 dark:bg-gray-700 transition-colors">
                    <div
                ...
                <p className="text-xs text-gray-500 mt-1 group-hover:text-gray-600 dark:text-gray-400 transition-colors">{c.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4">
        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-4">60-Day Component Trend</h3>
      ...
      {/* Active alerts */}
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4">
        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-4">Active Risk Alerts</h3>
