...
import { LayoutDashboard, Activity, Bell, Shield, Users, UserCog, BarChart3, AlertTriangle, FileText, Gauge, MessageSquare, Bot, Database, Sun, Moon } from 'lucide-react'
